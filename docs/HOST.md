...
| Docker | 28.5.2 client present; **daemon was not running** on 2026-08-30 so RUHMI image was not built |
| RUHMI/MERA | not installed on macOS; x86_64 manylinux cp310 wheel only |
